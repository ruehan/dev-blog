---
title: "React와 OpenLayers를 활용한 강아지 산책 앱 구현: 지도"
date: "2024-11-19"
excerpt: "React와 OpenLayers를 사용하여 강아지 산책 앱을 개발하면서 겪었던 문제점들과 해결 방법, 그리고 구현 과정을 자세히 설명합니다."
tags: ["React", "OpenLayers", "DDang"]
category: "개발"
---
